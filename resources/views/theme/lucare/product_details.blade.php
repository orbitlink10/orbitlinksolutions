...
@section('meta_description', Str::limit($product->meta_description, 150))
...
<meta property="og:description" content="{{ Str::limit($product->meta_description, 160) }}" />
...
<meta name="twitter:description" content="{{ Str::limit($product->meta_description, 160) }}" />
