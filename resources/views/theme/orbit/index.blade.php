    ...
    <div class="container">
        <div class="tab-header featured-header">
            ...
            <div class="d-flex align-items-center gap-2">
                ...
                <div class="controls featured-controls">
                    <button class="btn btn-outline-secondary btn-sm featured-prev" aria-label="Previous">
                        <i class="fas fa-chevron-left"></i>
                    </button>
                    <button class="btn btn-outline-secondary btn-sm featured-next" aria-label="Next">
  ...
  (function($){
    $(function(){
      $('.featured-product-slider').each(function(){
        ...
        var $controls = $slider.closest('.product-tabs').find('.featured-controls');
        $controls.find('.featured-prev').off('click.slick').on('click.slick', function(){
          $slider.slick('slickPrev');
        });
        $controls.find('.featured-next').off('click.slick').on('click.slick', function(){
