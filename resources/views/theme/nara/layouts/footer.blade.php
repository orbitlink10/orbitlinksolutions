                ...
                <div class="col-lg-4 col-md-6">
                    <div class="widget-about font-md mb-md-5 mb-lg-0">
                        <div class="logo logo-width-1 wow fadeIn animated">
                            <a href="{{ url('/') }}"><img src="{{ uploaded_image_url(get_option('logo'), asset('lucare/assets/imgs/theme/logo.svg')) }}" alt="{{ get_option('site_name', 'Orbitlink Solutions') }} logo"></a>
                        </div>
...
footer.main a{color:#dbe2ff;}
footer.main a:hover{color:#ffffff;}
footer.main .widget-title,
footer.main h5,
footer.main strong{color:#ffffff;}
footer.main .footer-bottom{border-top:1px solid rgba(255,255,255,.12);} 
