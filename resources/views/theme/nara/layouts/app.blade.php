        ...
        <div class="header-top header-top-ptb-1 d-none d-lg-block">
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-6 col-lg-4">
                        <div class="text-center">
                            <div id="news-flash" class="d-inline-block">
                                @php $notice = trim((string) get_option('top_notice')); @endphp
                                <ul>
                                    @if($notice !== '')
                                        <li><i class="fas fa-bullhorn me-2"></i>{{ $notice }}</li>
                                    @else
                                        <li>Get great products up to 60% off <a href="{{url ('shop')}}">View details</a></li>
                                        <li>Supper Value Deals - Save more with coupons</li>
                                        <li>Save up 60% off today <a href="{{url ('shop')}}">Shop now</a></li>
                                    @endif
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-3 col-lg-4">
                        <div class="header-info header-info-right"></div>
                    </div>
                </div>
            </div>
        </div>
