...
<style>
    :root {
        ...
        --theme-light: #66c2cc; /* Example lighter variant */
    }
    .text-brand {
        color: var(--theme-color) !important;
    }
    /* Optional: override Bootstrap’s text-success if you want to use your theme color */
                ...
                <div class="row align-items-center slider-animated-1">
                    <div class="col-lg-6 col-md-6">
                        <div class="hero-slider-content-2">
                            <h4 class="animated fadeInUp delay-0-2">{{ $slider->h4_title }}</h4>
                            <h2 class="animated fadeInUp delay-0-4 fw-900">{{ $slider->h2_title }}</h2>
                            <h1 class="animated fadeInUp delay-0-6 fw-900 text-brand">{{ $slider->h1_title }}</h1>
...
<section class="bg-light py-4" id="services">
    <div class="container">
        ...
        <div class="text-center mb-4">
            <h2 class="fw-bold text-brand">Our Services</h2>
