...
@section('title') Welding Products @endsection

@section('main')
<div class="container py-5">
    <h1 class="mb-5 text-center fw-bold text-success">Our Welding Products</h1>
    ...
    <div class="mb-5 text-center">
        ...
        <div class="d-inline-flex flex-wrap gap-2 justify-content-center">
            <a href="{{ route('welding-products.index') }}"
               class="btn btn-sm btn-outline-success rounded-pill {{ request()->routeIs('welding-products.index') ? 'active fw-bold' : '' }}">
                All
            </a>
            @foreach($categories as $category)
                <a href="{{ route('welding-products.category', $category->slug) }}"
                   class="btn btn-sm btn-outline-success rounded-pill {{ request()->segment(3) === $category->slug ? 'active fw-bold' : '' }}">
                    {{ $category->name }}
                </a>
            @endforeach
        </div>
